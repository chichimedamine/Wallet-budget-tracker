...
class BarChartSample2 extends StatefulWidget {
  ...
  final Color leftBarColor = ColorsHelper.green;
  final Color rightBarColor = ColorsHelper.white;
  final Color avgColor =
      ColorsHelper.blendColors(ColorsHelper.green, ColorsHelper.white, 0.5);
  @override
...
class BarChartSample2State extends State<BarChartSample2> {
  ...
  Widget leftTitles(double value, TitleMeta meta) {
    TextStyle style = FontsHelper.boldTextStyle(
      color: ColorsHelper.white,
      fontSize: 14,
    );
    String text;
